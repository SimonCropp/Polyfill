...
static partial class Polyfill
{
    ...
    /// </summary>
    //Link: https://learn.microsoft.com/en-us/dotnet/api/system.io.directory.enumeratefiles?view=net-10.0#system-io-directory-enumeratefiles(system-string-system-string-system-io-enumerationoptions)
    ...
    /// </summary>
    //Link: https://learn.microsoft.com/en-us/dotnet/api/system.io.directory.enumeratedirectories?view=net-10.0#system-io-directory-enumeratedirectories(system-string-system-string-system-io-enumerationoptions)
    ...
    /// </summary>
    //Link: https://learn.microsoft.com/en-us/dotnet/api/system.io.directory.enumeratefilesystementries?view=net-10.0#system-io-directory-enumeratefilesystementries(system-string-system-string-system-io-enumerationoptions)
    ...
    /// </summary>
    //Link: https://learn.microsoft.com/en-us/dotnet/api/system.io.directory.getfiles?view=net-10.0#system-io-directory-getfiles(system-string-system-string-system-io-enumerationoptions)
    ...
    /// </summary>
    //Link: https://learn.microsoft.com/en-us/dotnet/api/system.io.directory.getdirectories?view=net-10.0#system-io-directory-getdirectories(system-string-system-string-system-io-enumerationoptions)
    ...
    /// </summary>
    //Link: https://learn.microsoft.com/en-us/dotnet/api/system.io.directory.getfilesystementries?view=net-10.0#system-io-directory-getfilesystementries(system-string-system-string-system-io-enumerationoptions)
