...
static partial class Polyfill
{
    ...
    /// <returns>A string whose contents match the current string, but with all newline sequences replaced with replacementText.</returns>
    [Link("https://learn.microsoft.com/en-us/dotnet/api/system.string.replacelineendings")]
    ...
    /// </summary>
    /// <returns>A string whose contents match the current string, but with all newline sequences replaced with NewLine.</returns>
    [Link("https://learn.microsoft.com/en-us/dotnet/api/system.string.replacelineendings")]
