...
public
#endif
static partial class Int16Polyfill
{
    extension(short)
    {
        ...
        public static bool TryParse(ReadOnlySpan<byte> s, out short result) =>
            short.TryParse(Encoding.UTF8.GetString(s), NumberStyles.Integer, null, out result);
