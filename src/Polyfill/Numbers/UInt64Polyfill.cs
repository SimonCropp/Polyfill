...
public
#endif
static partial class UInt64Polyfill
{
    extension(ulong)
    {
        ...
        public static bool TryParse(ReadOnlySpan<byte> s, IFormatProvider? provider, out ulong result) =>
            ulong.TryParse(Encoding.UTF8.GetString(s), NumberStyles.Integer, provider, out result);
        ...
        public static bool TryParse(ReadOnlySpan<byte> s, NumberStyles style, IFormatProvider? provider, out ulong result) =>
            ulong.TryParse(Encoding.UTF8.GetString(s), style, provider, out result);
