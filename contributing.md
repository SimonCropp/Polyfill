...
<!-- snippet: Polyfill/ModuleInitializerAttribute.cs -->
<a id='snippet-Polyfill/ModuleInitializerAttribute.cs'></a>
```cs
#if !NET
...
#endif
```
<sup><a href='/src/Polyfill/ModuleInitializerAttribute.cs#L1-L29' title='Snippet source file'>snippet source</a> | <a href='#snippet-Polyfill/ModuleInitializerAttribute.cs' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<!-- snippet: Polyfill/Polyfill_TextWriter.cs -->
<a id='snippet-Polyfill/Polyfill_TextWriter.cs'></a>
```cs
// <auto-generated />
#pragma warning disable
...
```
<sup><a href='/src/Polyfill/Polyfill_TextWriter.cs#L1-L187' title='Snippet source file'>snippet source</a> | <a href='#snippet-Polyfill/Polyfill_TextWriter.cs' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
