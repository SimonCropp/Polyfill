 ...
 * Symbols 71KB
 ...
 with no code that pulls in all Polyfill features


### Assembly load time

The time taken to load and JIT code is proportional to the amount of IL in that code. So a larger assembly, with more IL, will take longer.
