 ...
 * `Void Write(ReadOnlyMemory<Char>)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.io.textwriter.write?view=net-7.0#system-io-textwriter-write(system-readonlyspan((system-char))))
 ...
 * `Void WriteLine(ReadOnlyMemory<Char>)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.io.textwriter.writeline?view=net-7.0#system-io-textwriter-writeline(system-readonlyspan((system-char))))
