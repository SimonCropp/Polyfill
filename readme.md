...
[![Build status](https://github.com/SimonCropp/Polyfill/actions/workflows/build.yml/badge.svg)](https://github.com/SimonCropp/Polyfill/actions/workflows/build.yml)
...
**API count: 1182**<!-- include: apiCount. path: /apiCount.include.md -->
...
| netstandard2.1 |          8.5KB |       345.0KB |  +336.5KB |    +8.5KB |             +6.0KB |              +8.5KB |     +13.5KB |
...
| netstandard2.1 |          8.5KB |       495.2KB |  +486.7KB |   +16.2KB |             +7.7KB |             +13.4KB |     +18.9KB |
...
| net7.0         |         10.0KB |       315.4KB |  +305.4KB |   +17.1KB |             +7.4KB |              +1.1KB |      +4.2KB |
 ...
 * `int ToInt32(ReadOnlySpan<byte>)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.bitconverter.toint32?view=net-11.0#system-bitconverter-toint32(system-readonlyspan((system-byte))))
 * `long ToInt64(ReadOnlySpan<byte>)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.bitconverter.toint64?view=net-11.0#system-bitconverter-toint64(system-readonlyspan((system-byte))))
 * `float ToSingle(ReadOnlySpan<byte>)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.bitconverter.tosingle?view=net-11.0#system-bitconverter-tosingle(system-readonlyspan((system-byte))))
 ...
 * `ushort ToUInt16(ReadOnlySpan<byte>)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.bitconverter.touint16?view=net-11.0#system-bitconverter-touint16(system-readonlyspan((system-byte))))
 * `uint ToUInt32(ReadOnlySpan<byte>)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.bitconverter.touint32?view=net-11.0#system-bitconverter-touint32(system-readonlyspan((system-byte))))
 * `ulong ToUInt64(ReadOnlySpan<byte>)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.bitconverter.touint64?view=net-11.0#system-bitconverter-touint64(system-readonlyspan((system-byte))))
 * `bool TryWriteBytes(Span<byte>, bool)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.bitconverter.trywritebytes?view=net-11.0#system-bitconverter-trywritebytes(system-span((system-byte))-system-boolean))
 ...
 * `bool TryWriteBytes(Span<byte>, short)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.bitconverter.trywritebytes?view=net-11.0#system-bitconverter-trywritebytes(system-span((system-byte))-system-int16))
 * `bool TryWriteBytes(Span<byte>, uint)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.bitconverter.trywritebytes?view=net-11.0#system-bitconverter-trywritebytes(system-span((system-byte))-system-uint32))
 ...
 * `byte Log10(byte)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.byte.log10?view=net-11.0)
 ...
 * `short Log10(short)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.int16.log10?view=net-11.0)
 ...
 * `ProcessExitStatus Run(string, IEnumerable<string>?, bool, TimeSpan?)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.diagnostics.process.run?view=net-11.0#system-diagnostics-process-run(system-string-system-collections-generic-ienumerable((system-string))-system-boolean-system-nullable((system-timespan))))
 ...
 * `ProcessTextOutput RunAndCaptureText(string, IEnumerable<string>?, TimeSpan?)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.diagnostics.process.runandcapturetext?view=net-11.0#system-diagnostics-process-runandcapturetext(system-string-system-collections-generic-ienumerable((system-string))-system-nullable((system-timespan))))
 ...
 * `int StartAndForget(string, IEnumerable<string>?)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.diagnostics.process.startandforget?view=net-11.0#system-diagnostics-process-startandforget(system-string-system-collections-generic-ienumerable((system-string))))
 ...
 * `int Count(ReadOnlySpan<char>, int)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.text.regularexpressions.regex.count?view=net-11.0#system-text-regularexpressions-regex-count(system-readonlyspan((system-char))-system-int32))
 * `int Count(ReadOnlySpan<char>)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.text.regularexpressions.regex.count?view=net-11.0#system-text-regularexpressions-regex-count(system-readonlyspan((system-char))))
 ...
 * `int Count(ReadOnlySpan<char>, string, RegexOptions, TimeSpan)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.text.regularexpressions.regex.count?view=net-11.0#system-text-regularexpressions-regex-count(system-readonlyspan((system-char))-system-string-system-text-regularexpressions-regexoptions-system-timespan))
 * `int Count(ReadOnlySpan<char>, string, RegexOptions)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.text.regularexpressions.regex.count?view=net-11.0#system-text-regularexpressions-regex-count(system-readonlyspan((system-char))-system-string-system-text-regularexpressions-regexoptions))
 * `int Count(ReadOnlySpan<char>, string)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.text.regularexpressions.regex.count?view=net-11.0#system-text-regularexpressions-regex-count(system-readonlyspan((system-char))-system-string))
 ...
 * `sbyte Log10(sbyte)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.sbyte.log10?view=net-11.0)
 ...
 * `StringBuilder Replace(Rune, Rune, int, int)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.text.stringbuilder.replace?view=net-11.0#system-text-stringbuilder-replace(system-text-rune-system-text-rune-system-int32-system-int32))
 * `StringBuilder Replace(Rune, Rune)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.text.stringbuilder.replace?view=net-11.0#system-text-stringbuilder-replace(system-text-rune-system-text-rune))
 * `bool TryGetRuneAt(int, Rune)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.text.stringbuilder.trygetruneat?view=net-11.0)
 ...
 * `ushort Log10(ushort)` [reference](https://learn.microsoft.com/en-us/dotnet/api/system.uint16.log10?view=net-11.0)
...
```
<sup><a href='/src/Consume/Consume.cs#L1009-L1033' title='Snippet source file'>snippet source</a> | <a href='#snippet-ArgumentExceptionUsage' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
```
<sup><a href='/src/Consume/Consume.cs#L1039-L1051' title='Snippet source file'>snippet source</a> | <a href='#snippet-EnsureUsage' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
See [compiler breaking changes - dotnet 10](https://learn.microsoft.com/en-us/dotnet/csharp/whats-new/breaking-changes/compiler%20breaking%20changes%20-%20dotnet%2010#enumerablereverse) for more details.
